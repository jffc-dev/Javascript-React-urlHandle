  ...
  return (
    <Modal
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">DETALLES DE LA URL</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Tabs defaultActiveKey="titles" id="uncontrolled-tab-example" className="mb-3">
          ...
          <Tab eventKey="titles" title="Títulos">
            <AleatorioUrlsBdModalTabTitles
              cadenaId={cadenaId}
              titles={titles}
              setTitles={setTitles}></AleatorioUrlsBdModalTabTitles>
          </Tab>
          <Tab eventKey="resets" title="Urls">
            <AleatorioUrlsBdModalTabResets resets={resets}></AleatorioUrlsBdModalTabResets>
          </Tab>
        </Tabs>
      </Modal.Body>
